...
boreal_forest_ne <- hcl.colors(6, "Purples")
#nearctic
boreal_forest_ne2 <- hcl.colors(6, "Purples")
#nearctic
boreal_forest_ne3 <- hcl.colors(6, "Purples")
#nearctic
boreal_forest_ne4 <- hcl.colors(6, "Purples")

boreal_forest_eu <- hcl.colors(6, "Blues 3")
#europe
boreal_forest_eu_W <- hcl.colors(6, "Blues 3")
#europe
boreal_forest_eu_E <- hcl.colors(6, "Blues 3")
#europe
boreal_forest_eu_E2 <- hcl.colors(6, "Blues 3")
#europe
