...
load("//smb.isipd.dmawi.de/projects/bioing/user/slisovsk/ArcticSDM/data/GBIF_dataComp/occTab_all.rda")
...
#st_data <- st_as_stars(occTab_wgs84) 
...
ggsave("C:/Users/roschw001/Documents/R/SDM/SDM/ArcticSDMserver/ArcticSDM/plots/f1a.png", occs, units = "cm", width = 14, height = 14)
